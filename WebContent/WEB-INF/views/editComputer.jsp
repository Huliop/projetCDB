            ...
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="editComputer" method="POST">
                        <input type="hidden" value="${ computer.id }" id="id" name="idComputer"/> <!-- TODO: Change this value with the computer id -->
                        <fieldset>
                            <div class="form-group">
                                <label for="computerName">Computer name</label>
                                <c:choose>
                                    <c:when test='${ empty requestScope.errors }'>
                                        <input type="text" autocomplete="false" class="form-control" id="computerName" name="computerName" placeholder="Ex : PC de Schwarzeneger" value="<c:out value='${ computer.name }' />">
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <span id="erreurName" class="text-danger" style="display:none;">You must give a computer name</span>
                            </div>
                            <div class="form-group">
                                <label for="introduced">Introduced date</label>
                                <input type="date" class="form-control" id="introduced" placeholder="Introduced date" name="introducedDate" value="<c:out value='${ computer.introduced }' />">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="discontinued" placeholder="Discontinued date" name="discontinuedDate" value="<c:out value='${ computer.discontinued }' />">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="company" id="companyId" >
                                    ...
                                    <c:forEach var="comp" items="${ requestScope.companies }">
                                        <option value="${ comp.id }" <c:if test="${ comp.id == computer.company.id }">selected</c:if>>${ comp.name }</option>
                                    </c:forEach>
                                </select>
                            </div>            
                        </fieldset>
